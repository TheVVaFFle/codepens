...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function getCoins() {
      ...
      axios.get('https://api.coinmarketcap.com/v1/ticker/').then(function (res) {
    ...
    value: function render() {
      var _state = this.state,
          ...
          isShowingTooltip = _state.isShowingTooltip;
      ...
      return React.createElement(
        'div',
        { id: 'app', className: updating ? 'updating' : '' },
        React.createElement('div', { id: 'particles' }),
        React.createElement(
          'div',
          { id: 'help-tooltip', className: isShowingTooltip ? 'showing' : 'hide' },
          ...
          React.createElement(
            ...
            React.createElement(
              'span',
              { className: 'text' },
              'Hover over the coin icon and scroll.'
            ),
...
var Card = function (_React$Component2) {
  ...
  _createClass(Card, [{
    key: 'determineSign',
    value: function determineSign(num) {
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        { id: 'card-wrapper', className: colorClass },
        React.createElement(
          'div',
          { id: 'card' },
          React.createElement(
            'div',
            { id: 'card-left', className: 'card-half' },
          ...
          React.createElement(
            'div',
            { id: 'card-right', className: 'card-half' },
            React.createElement(
              'div',
              { id: 'card-right-contents' },
              React.createElement(
                'div',
                { id: 'coin-header' },
                React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  'div',
                  { id: 'coin-change-24hr', className: this.determineSign(coin.change24hr) },
                  React.createElement(
                    'h1',
                    null,
                    coin.change24hr,
...
var CoinSelection = function (_React$Component3) {
  _inherits(CoinSelection, _React$Component3);

  function CoinSelection(props) {
    _classCallCheck(this, CoinSelection);

    var _this6 = _possibleConstructorReturn(this, (CoinSelection.__proto__ || Object.getPrototypeOf(CoinSelection)).call(this, props));
  ...
  _createClass(CoinSelection, [{
    key: 'setCurrentScrollTop',
    value: function setCurrentScrollTop(val) {
      this.setState({ currentScrollTop: val });
    }
  }, {
    key: 'moveScrollTop',
    value: function moveScrollTop() {
    ...
    value: function render() {
      ...
      var coinOptions = this.props.coins.slice(0, 10).map(function (coin) {
        ...
        return React.createElement(
          'div',
          { key: coin.symbol, className: 'coin-option ' + (selected ? 'selected' : '') },
          React.createElement('div', { className: 'coin-option-icon', style: { backgroundImage: 'url(' + coin.img + ')' } })
        );
      });
      return React.createElement(
        'div',
        { id: 'coin-selection', onMouseLeave: this.moveScrollTop },
        React.createElement(
          'div',
